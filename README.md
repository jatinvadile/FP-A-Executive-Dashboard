...
4. Built Expenses Breakdown across Operating ($38.51M), Admin ($19.72M), and Personnel ($19.79M) with Personnel drill-down showing Basic Salary, Overtime, Contributions, and CTC vs Non-CTC split.
5. Created Revenue vs Budget comparison chart showing actual vs budget variance month-on-month - identifying months with up to 20.5% budget outperformance.
6. Implemented dynamic DAX measures for EBITDA %, LY variance, LM variance, and budget deviation across all KPIs.
